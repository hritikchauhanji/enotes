...
public class SwaggerConfig {
	...
	public OpenAPI openAPI() {
		...
		info.setTermsOfService("https://www.hritikchji.com");
		info.setContact(new Contact().email("hritikchji@gmail.com")
				.name("Hritik Chauhan").url("https://www.hritikchji.com/contact"));
		info.setLicense(new License().name("Enotes 1.0").url("https://www.hritikchji.com"));
		...
		// bearer sdfshdls.sdkjfls.sjdflsjdls
